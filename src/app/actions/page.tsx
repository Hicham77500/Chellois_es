  ...
  const upcomingEvents = [
    {
      ...
      description: "Mercredi 18/02 à 17h30 - poursuite porte à porte Gambetta",
      type: "event-text",
      calendarDay: 18,
    },
    {
      ...
      month: "fév",
      day: 19,
      title: "Tractage école Lise London",
      description: "Jeudi 19/02 à 16h40 - tractage école Lise London",
      type: "event-text",
      calendarDay: 19,
    },
    {
      ...
      month: "fév",
      day: 20,
      title: "Tractage école Calmette",
      description: "Vendredi 20/02 à 16h40 - tractage école Calmette",
      type: "event-text",
      calendarDay: 20,
    },
    {
      ...
      month: "fév",
      day: 21,
      title: "Porte à porte Tournelles",
      description: "Samedi 21/02 à 14h30 - porte à porte Tournelles",
      type: "event-text",
      calendarDay: 21,
    },
    {
      ...
      month: "fév",
      day: 22,
      title: "Tractage Carrefour market Gambetta",
      description: "Dimanche 22/02 à 10h30 - tractage Carrefour market Gambetta",
      type: "event-text",
      calendarDay: 22,
    },
  ];
