  ...
  const upcomingEvents = [
    {
      ...
      month: "fév",
      day: 9,
      title: "Tractage École Grande Prairie",
      description: "Lundi 09/02 à 16h40 - tractage école Grande Prairie",
      type: "event-text",
      calendarDay: 9,
    },
    {
      ...
      month: "fév",
      day: 11,
      title: "Porte à porte Gambetta",
      description: "Mercredi 11/02 à 17h - porte à porte Gambetta",
      type: "event-text",
      calendarDay: 11,
    },
    {
      ...
      month: "fév",
      day: 12,
      title: "Tractage Pôle Emploi",
      description: "Jeudi 12/02 à 9h - tractage pôle emploi",
      type: "event-text",
      calendarDay: 12,
    },
    {
      ...
      month: "fév",
      day: 13,
      title: "Tractage Écoles Jules Vernes",
      description: "Vendredi 13/02 à 16h40 - tractage écoles Jules Vernes",
      type: "event-text",
      calendarDay: 13,
    },
    {
      ...
      day: 14,
      title: "Porte à porte Gambetta",
      description: "Samedi 14/02 à 14h30 - poursuite du porte à porte à Gambetta",
      type: "event-text",
      calendarDay: 14,
    },
    {
      ...
      month: "fév",
      day: 15,
      title: "Tractage Marché de Chelles",
      description: "Dimanche 15/02 à 10h30 - tractage marché de Chelles",
      type: "event-text",
      calendarDay: 15,
    },
  ];
