...
const citizens = [
  ...
  },
  {
    ...
    vision: `Présentation de Candidate 4, 55 ans

  🏠 Je m’appelle Candidate 4. Chelles, c’est ma ville. J’y ai grandi, j’y ai construit ma vie, j’y ai vu passer les années, les visages, les histoires. Ici, chaque rue porte un souvenir, chaque quartier fait partie de mon histoire.
