  ...
  const upcomingEvents = [
    {
      ...
      month: "mars",
      day: 9,
      title: "Tractage école Fournier",
      description: "Lundi 09/03 à 16h40 - Tractage école Fournier",
      type: "event-text",
      calendarDay: 9,
    },
    {
      ...
      month: "mars",
      day: 10,
      title: "Tractage école Mont-Chalats",
      description: "Mardi 10/03 à 16h40 - Tractage école Mont-Chalats",
      type: "event-text",
      calendarDay: 10,
    },
    {
      ...
      month: "mars",
      day: 11,
      title: "Tractage gare Chelles-Gournay",
      description: "Mercredi 11/03 à 17h - Tractage gare Chelles-Gournay",
      type: "event-text",
      calendarDay: 11,
    },
    {
      ...
      month: "mars",
      day: 12,
      title: "Tractage école Jules Ferry",
      description: "Jeudi 12/03 à 16h40 - Tractage école Jules Ferry",
      type: "event-text",
      calendarDay: 12,
    },
    {
      ...
      month: "mars",
      day: 13,
      title: "Tractage école Vieux Colombier",
      description: "Vendredi 13/03 à 16h40 - Tractage école Vieux Colombier",
      type: "event-text",
      calendarDay: 13,
    },
  ];
